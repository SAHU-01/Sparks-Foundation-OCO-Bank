...
mongoose.connect(`mongodb+srv://ankita_sahu:${process.env.MONGO_PASSWORD}@ocobank1.x16jq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority` || "mongodb://localhost:27017/banking", { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: false })
    .then(() => {
